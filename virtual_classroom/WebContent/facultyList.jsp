	...
	<div class="wrap">
		<div class="content">
			<div class="section group">
				...
				<h1 style="color:orange;font-size: 24px">Faculty List...</h1><br>
				<table border="20" >
		<tr>
			<th align="center" style="color:blue"><label>Faculty ID </label></th>
		...
		<tr>																	
			<td align="center">
			<s:property value="facultyID" ></s:property></td>	
