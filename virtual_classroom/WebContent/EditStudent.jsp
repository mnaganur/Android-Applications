			...
			<div class="section group">
				<div class="col span_1_of_3">
					...
					<div class="company_address">
						...
						<br>
						<h2 class="italic">A leader is one who knows the way, goes the way, and shows the way !!!!!!!!!- John C. Maxwell</h2>
					</div>
				</div>
				<div class="col span_2_of_3">
					<div class="contact-form">
						...
						<img alt="" src="images\faculty.jpg" width="270px" height="350px"
							align="right">
						<s:form action="edits" theme="css_xhtml">
							<div>
								<span><label>User Name</label></span> <span><s:property required="true"
										value="userName" /></span>
							</div>
							...
							<div>
								...
								<div>
									...
									<s:hidden name="userNames"></s:hidden>
