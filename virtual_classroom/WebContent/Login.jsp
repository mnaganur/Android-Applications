			...
			<div class="section group">
				<div class="col span_1_of_3">
					...
					<div class="company_address">
						...
						<br>
						<h2 class="italic">Try not to become a man of success. Rather become a man of value !!!!!!!! - Albert Einstein</h2>
					</div>
				</div>
				<div class="col span_2_of_3">
					<div class="contact-form">
						<h3>Login Here</h3>
						<img alt="" src="images\slider3.jpg" width="270px" height="150px"
							align="right">
						...
						<s:hidden name="role"></s:hidden>
							<div>
								...
								<span><label>UserName</label></span> <span><s:textfield required="true"
										name="userName" class="textbox" /></span>
							</div>

							<div>
								<span><label>Password</label></span> <span><s:password required="true"
										 class="password" name="password"/></span>
							</div>

							<div>
								<span class="button-wrap"><s:submit value="login" /></span>
							</div>
							<div>
								<span ><s:url action="StudentRegister" var="enq1"></s:url>
									<s:a href="%{#enq1}" class="link">Register as Student</s:a></span> | 
								<span><s:url action="FacultyRegister" var="enq2"></s:url> 
								<s:a href="%{#enq2}">Register as Faculty</s:a></span>
							</div>
