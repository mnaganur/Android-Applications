			...
			<div class="section group">
				<div class="col span_1_of_3">
					...
					<div class="company_address">
						...
						<br>
						<h2 class="italic"> A good teacher can inspire hope, ignite the imagination, and instill a love of learning !!!!!!! - Brad Henry</h2>
					</div>
				</div>
				<div class="col span_2_of_3">
					<div class="contact-form">
						...
						<img alt="" src="images\faculty.jpg" width="270px" height="350px"
							align="right">
						<s:form action="facregister" theme="css_xhtml">
							<div>
							...
							<div>
								<span><label>Desired Password</label></span> <span><s:password required="true"
