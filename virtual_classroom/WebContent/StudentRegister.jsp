			...
			<div class="section group">
				<div class="col span_1_of_3">
					...
					<div class="company_address">
						...
						<br>
						<h2 class="italic">One of the very important characteristics of a student is to question. Let the students ask questions!!!!!!! -A. P. J. Abdul Kalam </h2>
					</div>
				</div>
				<div class="col span_2_of_3">
					<div class="contact-form">
						...
						<img alt="" src="images\faculty.jpg" width="270px" height="350px"
							align="right">
						<s:form action="stud_reg" theme="css_xhtml" >
							<div>
							...
							<div>
								<span><label>Desired Password</label></span> <span><s:password 
										class="password" name="desiredPassword" />
									</span>
							</div>
							...
							<div>
								<span class="button-wrap"><s:submit value="Register" /></span>
							</div>
