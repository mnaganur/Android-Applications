			...
			<div class="section group">
				<div class="col span_1_of_3">
					...
					<div class="company_address">
						...
						<br>
						<h2 class="italic">Phir Yo Yo Honey.. Yo Yo Honey singhh hi toh gayegi !!!!!!!!!!!!!!</h2>
					</div>
				</div>
				<div class="col span_2_of_3">
					<div class="contact-form">
						...
						<img alt="" src="images\faculty.jpg" width="270px" height="350px"
							align="right">
						<s:form action="add_stud" theme="css_xhtml">
							<div>
								<span><label>User Name</label></span> <span><s:textfield
										name="userName" class="textbox" /></span>
							</div>

							<div>
								<span><label>Desired Password</label></span> <span><s:password
										class="password" name="desiredPassword" /></span>
							</div>

							<div>
								<span><label>Classroom ID</label></span> <span><s:select 
										list="{'--select--','Java','MS.Net','Unix','BIPM'}" name="classroomID" cssClass="selectList"></s:select></span>
										<span><s:fielderror fieldName="classroomID" ></s:fielderror></span>
							</div>
							<div>
							
								<span><label>Email ID</label></span> <span><s:textfield
										name="emailID" /></span>
								</div>	
								<div>
							
								<span><label>Phone No.</label></span> <span><s:textfield
										name="phoneNO" /></span>
								</div>		
							...
							<div>
								<span class="button-wrap"><s:submit value="Add" /></span>
							</div>
